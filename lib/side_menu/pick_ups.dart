  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Pick Ups',style: GoogleFonts.montserrat(textStyle: TextStyle(fontWeight: FontWeight.w800,fontSize: 22)),),
      ),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(color: Color.fromRGBO(200, 92, 92, 0.6),borderRadius: BorderRadius.only(topLeft: Radius.circular(20),bottomLeft: Radius.circular(20))),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text('Cancle',textAlign: TextAlign.center,),
                            ),
                          )
                        ],
                      )
